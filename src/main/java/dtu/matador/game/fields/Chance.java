...
public class Chance extends NonPurchasableFields {

    public Chance(FieldController controller, String name, String subtext, String description, String color1, String color2, String position) {
